/*global Dashboard _config AmazonCognitoIdentity AWSCognito*/
...
(function($) {
    ...
    Dashboard.signOut = function signOut() {
        userPool.getCurrentUser().signOut();
    };

    Dashboard.authToken = new Promise(function fetchCurrentAuthToken(resolve, reject) {
